...
def simulate_championship(players, arbrito, chave_campeonato, start_date, end_date, rand_hospedagem):
    ...
    with open("championship.csv", "w", newline="") as csvfile:
        ...
        for game_id in range(num_games):
            ...
            chave_salao =  subscribe_game_place(hosp_id,hosp_name, chave_campeonato, data_inicio, data_fim)
            ...
            subscribe_game(jogador_primario,jogador_secundario,arbitro,jogador_primario,jogador_secundario,data_inicio,data_fim,vencedor,chave_campeonato,chave_salao,numeros_jogadas)
...
def pegar_campeonatos():
    ...
    new_record_list = [{'id': d['id'], 'nome': d['nome'], 'data_inicio': d['data_inicio'] } for d in record_list]
...
def get_matches(campeonato_id, start_date):
    ...
    # Gerar os jogos
    simulate_championship(player_list, arbrito, chave_campeonato, start, end,rand_hospedagem)
...
def subscribe_game(jogador_primario,jogador_secundario,arbitro,pecas_pretas,pecas_brancas,data_inicio,data_fim,vencedor,chave_campeonato,chave_salao,numero_jogadas):
