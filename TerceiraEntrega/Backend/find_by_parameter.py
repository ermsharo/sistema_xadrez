    ...
    new_record_list = [
        {
            ...
            "data_fim": d["data_fim"],
            "vencedor": query_participantes(
                participantes, d["vencedor"]
            ),
...
@programacao_parametro.route("/programacao_parametros/<participante>/<hospedagem>")
def programacao_parametros(participante, hospedagem):
    print("Participante", participante)
    print("Hospedagem", hospedagem)
    # Access the values of the parameters using the 'parametro1' and 'parametro2' variables
    # Use the values to perform necessary operations
    return 'aaa'